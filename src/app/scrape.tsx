...
export async function formFiller(): Promise<scrapeResult> {
  ...
  try {
    ...
    for (var i = 0; i < 1; i++) {
      ...
      await kyoChonPage.goto('https://loyalty.kyochon.com.my', { waitUntil: 'domcontentloaded' });
      await tempMailPage.goto('https://temp-mail.org/en/', { waitUntil: 'domcontentloaded' })
      ...
      await (await tempMailPage.waitForSelector(`::-p-xpath(/html/body/div[3]/div/div/div[2]/div[1]/form/div[1]/div/button[2])`, { timeout: 3000 })).click();
      ...
      await (await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[3]/div/input)`, { timeout: 300000 })).type(password);
      await (await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[4]/div/input)`, { timeout: 300000 })).type(password);
      await (await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[5]/div/input)`, { timeout: 300000 })).type(randFirst());
      await (await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[6]/div/input)`, { timeout: 300000 })).type(randLast());

      const genderSelect = await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[7]/div/div/select)`, { timeout: 300000 })
      const daySelect = await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[8]/div[1]/div/div/select)`, { timeout: 300000 })
      const monthSelect = await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[8]/div[2]/div/div/select)`, { timeout: 300000 })
      const yearSelect = await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[8]/div[3]/div/div/select)`, { timeout: 300000 })
      const stateSelect = await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[9]/div/div/select)`, { timeout: 300000 })

      await selectIndex(genderSelect, randSelect(1, 2))
      await selectIndex(daySelect, randSelect(1, 25));
      ...
      await (await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/div[10]/input)`, { timeout: 300000 })).type("QD0785");
      await (await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/button)`, { timeout: 300000 })).click();
      await delay(2000);
      await (await kyoChonPage.waitForSelector(`::-p-xpath(/html/body/div[5]/div[1]/div/div[3]/div/div[2]/form/button)`, { timeout: 300000 })).click();
      await tempMailPage.bringToFront();
      ...
      const emailLink = await tempMailPage.waitForSelector(`::-p-xpath(/html/body/main/div[1]/div/div[2]/div[2]/div/div[1]/div/div[4]/ul/li[2]/div[1]/a)`, { timeout: 300000 });
...
async function launchBrowser({ proxy }: { proxy: boolean }): Promise<launchBrowserReturn> {
  ...
  const browser = await puppeteer.launch({
    ...
    userDataDir: path.join(os.tmpdir(), 'fresh_edge_session'),
    
    args: [
      '--profile-directory=Profile 52',
      '--no-sandbox',
